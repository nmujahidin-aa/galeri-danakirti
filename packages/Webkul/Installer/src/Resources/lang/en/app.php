    ...
    'seeders' => [
        ...
        'shop' => [
            'theme-customizations' => [
                ...
                'bold-collections' => [
                    'content' => [
                        'btn-title'   => 'Tentang Kami',
                        'description' => 'Danakirti adalah komunitas di bawah naungan Gerdu Sawah yang bertujuan untuk mewadahi dan mendukung pertumbuhan UMKM di Desa Wonorejo. Selain itu, komunitas ini juga aktif di bidang sosial, khususnya dalam memberdayakan mantan ODGJ agar dapat kembali mandiri dan berdaya di tengah masyarakat.',
                        'title'       => 'Mengenal lebih jauh tentang Danakirti!',
                    ],
                ...
                'footer-links' => [
                    ...
                    'options' => [
                        'economic-course'  => 'Pelatihan Ekonomi',
                        'self-course'      => 'Pelatihan Pengembangan Diri',
                        'activity'         => 'Kegiatan',
                        'news'             => 'Berita Terkini',
                ...
                'offer-information' => [
                    'content' => [
                        'title' => 'Setiap produk dipilih dengan cermat untuk memberikan kenyamanan, kepraktisan, dan daya tahan yang luar biasa',
                    ],
                ...
                'services-content' => [
                    'description' => [
                        'emi-available-info'   => 'Tersedia untuk pembelian produk',
                        'free-shipping-info'   => 'Siap kirim ke seluruh Indonesia',
                        'product-replace-info' => 'Garansi penggantian produk',
                        'time-support-info'    => '24/7 Bantuan tersedia untuk Anda!',
                    ],

                    'name' => 'Services Content',

                    'title' => [
                        'emi-available'   => 'Transfer',
                        'free-shipping'   => 'Siap Kirim',
                        'product-replace' => 'Bergaransi',
                        'time-support'    => '24/7 Bantuan',
                    ],
                ],

                'top-collections' => [
                    'content' => [
                        'sub-title-1' => 'Pelatihan Konseling',
                        'sub-title-2' => 'Pelatihan Wawasan',
                        'sub-title-3' => 'Pameran Produk',
                        'sub-title-4' => 'Pelatihan Packaging',
                        'sub-title-5' => 'Pealatihan Kewirausahaan',
                        'sub-title-6' => 'Kunjungan Dinas',
                        'title'       => 'Kegiatan dan Aktivitas Danakirti',
                    ],
