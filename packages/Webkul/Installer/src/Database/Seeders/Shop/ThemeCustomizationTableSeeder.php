                ...
                ->insert([
                    ...
                    [
                        ...
                        'options'                => json_encode([
                            'column_1' => [
                                [
                                    'url'        => $appUrl.'/page/economic-course',
                                    'title'      => trans('installer::app.seeders.shop.theme-customizations.footer-links.options.economic-course', [], $locale),
                                    'sort_order' => 1,
                                ],
                                [
                                    'url'        => $appUrl.'/page/self-course',
                                    'title'      => trans('installer::app.seeders.shop.theme-customizations.footer-links.options.self-course', [], $locale),
                                    'sort_order' => 2,
                                ],
                                [
                                    'url'        => $appUrl.'/page/activity',
                                    'title'      => trans('installer::app.seeders.shop.theme-customizations.footer-links.options.activity', [], $locale),
                                    'sort_order' => 3,
                                ],
                                [
                                    'url'        => $appUrl.'/page/news',
                                    'title'      => trans('installer::app.seeders.shop.theme-customizations.footer-links.options.news', [], $locale),
                                    'sort_order' => 4,
                                ],
                            ],
                            ...
                            'column_2' => [
                                ...
                                [
                                    'url'        => $appUrl.'/page/faq',
                                    'title'      => trans('installer::app.seeders.shop.theme-customizations.footer-links.options.faq', [], $locale),
                                    'sort_order' => 3,
                                ],
                            ],
                        ]),
