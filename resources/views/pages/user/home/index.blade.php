@extends('layouts.app')
@section('title', 'Beranda | Galeri-Danakirti')
@section('styles')
<link rel="stylesheet" href="{{URL::to('/')}}/assets/css/shop.min.css" />
@endsection
    ...
    <div class="container d-xl-flex align-items-start">
        <div class="hero_about col-xl-6">
            <div class="hero_header">
                <h1 class="hero_header-title">Danakirti</h1>
                <p class="hero_header-text">
                    Menghidupkan kembali warisan batik Nusantara melalui tangan para eks ODGJ, menciptakan karya penuh makna yang merefleksikan harapan, keberanian, dan pelestarian budaya.
                </p>
                <a class="hero_header-btn btn" href="">Tentang Kami</a>
            </div>
            <div class="hero_contacts">
                <p class="hero_contacts-text">Tim dukungan kami siap 24/7 untuk membantu masalah produk.</p>
            ...
            <div class="hero_slider swiper">
                <div class="swiper-wrapper">
                    <div class="hero_slider-slide d-flex flex-column flex-md-row justify-content-between justify-content-md-start align-items-md-center swiper-slide">
                        <div class="hero_slider-slide_media" style="margin-top: 100px;">
                            <picture>
                                <source data-srcset="{{URL::to('/')}}/assets/img/product/1.png" srcset="{{URL::to('/')}}/assets/img/product/1.png" type="image/webp" />
                                <img class="lazy" data-src="{{URL::to('/')}}/assets/img/product/1.png" src="{{URL::to('/')}}/assets/img/product/1.png" alt="media" />
                            </picture>
                        </div>
                        <div class="hero_slider-slide_main">
                            <h2 class="title">Keset Kaki</h2>
                            <p class="text">
                                Keset kaki berkualitas tinggi yang dirancang untuk menjaga kebersihan dan kenyamanan rumah Anda.
                            </p>
                            <ul class="list">
                    ...
                    >
                        <div class="hero_slider-slide_media" style="margin-top: 100px;">
                            <picture>
                                <source data-srcset="{{URL::to('/')}}/assets/img/product/2.png" srcset="{{URL::to('/')}}/assets/img/product/2.png" type="image/webp" />
                                <img class="lazy" data-src="{{URL::to('/')}}/assets/img/product/2.png" src="{{URL::to('/')}}/assets/img/product/2.png" alt="media" />
                            </picture>
                        </div>
                        <div class="hero_slider-slide_main">
                            <h2 class="title">Batik Ciprat</h2>
                            <p class="text">
                                Karya seni tradisional yang unik dengan motif abstrak yang tercipta dari teknik cipratan warna secara manual.
                            </p>
                            <ul class="list">
                                <li class="list-item d-flex align-items-center justify-content-center justify-content-sm-start">
                                    <span class="icon d-flex align-items-center justify-content-center">
                    ...
                    >
                        <div class="hero_slider-slide_media" style="margin-top: 100px;">
                            <picture>
                                <source data-srcset="{{URL::to('/')}}/assets/img/product/3.png" srcset="{{URL::to('/')}}/assets/img/product/3.png" type="image/webp" />
                                <img class="lazy" data-src="{{URL::to('/')}}/assets/img/product/3.png" src="{{URL::to('/')}}/assets/img/product/3.png" alt="media" />
                            </picture>
                        </div>
                        <div class="hero_slider-slide_main">
                            <h2 class="title">Bross Bunga</h2>
                            <p class="text">
                                Dirancang dengan detail yang menawan untuk menambah sentuhan elegan pada setiap penampilan Anda.
                            </p>
                            <ul class="list">
                                <li class="list-item d-flex align-items-center justify-content-center justify-content-sm-start">
                                    <span class="icon d-flex align-items-center justify-content-center">
...
<section class="featured section--nopb">
    <div class="container">
        <div class="featured_header">
            <h2 class="featured_header-title">Produk Unggulan</h2>
    ...
    <div class="container d-flex flex-column flex-lg-row">
        ...
        <div class="product_main col-lg-6">
            ...
            <div class="product_main-action d-flex align-items-center">
                <a class="btn" href="{{route('company.about')}}">Tentang Kami</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container d-md-flex flex-wrap flex-xxl-nowrap justify-content-between align-items-center">
        <div class="effects_header d-lg-flex flex-xxl-column col-md-12 col-xxl-auto">
            <div class="main col-lg-6 col-xl-12">
                ...
                <a class="effects_header-btn btn" href="#">Tentang Kami</a>
            </div>
...
<section class="latest section">
    <div class="container">
        <h2 class="latest_header">Berita Terkini</h2>
    ...
    <div class="container">
        <div class="instagram_header">
            ...
            <p class="instagram_header-text">
                Temukan inspirasi terbaru dan ikuti perjalanan kami di Instagram untuk konten yang menarik dan bermanfaat
            </p>
        </div>
    </div>
        ...
        <div class="swiper-wrapper">
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://www.instagram.com/galeri.danakirti/" target="_blank" rel="noopener norefferer">
                    <picture>
                        <source data-srcset="{{URL::to('/')}}/assets/img/post/1.jpeg" srcset="{{URL::to('/')}}/assets/img/post/1.jpeg" type="image/webp" />
                        <img class="lazy" data-src="{{URL::to('/')}}/assets/img/post/1.jpeg" src="{{URL::to('/')}}/assets/img/post/1.jpeg" alt="instagram post" />
                    </picture>
            ...
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://www.instagram.com/galeri.danakirti/" target="_blank" rel="noopener norefferer">
                    <picture>
                        <source data-srcset="{{URL::to('/')}}/assets/img/post/2.jpeg" srcset="{{URL::to('/')}}/assets/img/post/2.jpeg" type="image/webp" />
                        <img class="lazy" data-src="{{URL::to('/')}}/assets/img/post/2.jpeg" src="{{URL::to('/')}}/assets/img/post/2.jpeg" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
            ...
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://www.instagram.com/galeri.danakirti/" target="_blank" rel="noopener norefferer">
                    <picture>
                        <source data-srcset="{{URL::to('/')}}/assets/img/post/3.jpeg" srcset="{{URL::to('/')}}/assets/img/post/3.jpeg" type="image/webp" />
                        <img class="lazy" data-src="{{URL::to('/')}}/assets/img/post/3.jpeg" src="{{URL::to('/')}}/assets/img/post/3.jpeg" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
            ...
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://www.instagram.com/galeri.danakirti/" target="_blank" rel="noopener norefferer">
                    <picture>
                        ...
                        <img class="lazy" data-src="{{URL::to('/')}}/assets/img/post/4.jpeg" src="{{URL::to('/')}}/assets/img/post/4.jpeg" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
            ...
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://www.instagram.com/galeri.danakirti/" target="_blank" rel="noopener norefferer">
                    <picture>
                        ...
                        <img class="lazy" data-src="{{URL::to('/')}}/assets/img/post/5.jpeg" src="{{URL::to('/')}}/assets/img/post/5.jpeg" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
            ...
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://www.instagram.com/galeri.danakirti/" target="_blank" rel="noopener norefferer">
                    <picture>
                        ...
                        <img class="lazy" data-src="{{URL::to('/')}}/assets/img/post/6.jpeg" src="{{URL::to('/')}}/assets/img/post/6.jpeg" alt="instagram post" />
                    </picture>
                    <span class="overlay d-flex justify-content-center align-items-center">
                        <i class="icon-instagram"></i>
                    </span>
