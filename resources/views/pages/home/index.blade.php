    ...
    <div class="container d-xl-flex align-items-start">
        <div class="hero_about col-xl-6">
            <div class="hero_header">
                <h1 class="hero_header-title">Batik Danakirti</h1>
        ...
        <div class="swiper-wrapper">
            <div class="instagram_slider-slide swiper-slide">
                <a class="link" href="https://instagram.com" target="_blank" rel="noopener norefferer">
                    <picture>
                        <source data-srcset="{{URL::to('/')}}/assets/img/placeholder.jpg" srcset="{{URL::to('/')}}/assets/img/placeholder.jpg" type="image/webp" />
                        <img class="lazy" data-src="{{URL::to('/')}}/assets/img/placeholder.jpg" src="{{URL::to('/')}}/assets/img/placeholder.jpg" alt="instagram post" />
                    </picture>
