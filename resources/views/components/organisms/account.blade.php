<div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
    <!--begin::Symbol-->
    <div class="symbol symbol-50px" style="position: relative; overflow: hidden; width: 50px; height: 50px;">
        <img
        src="{{URL::to('/')}}/assets/media/avatars/150-26.jpg"
        alt="foto"
    ...
    <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
        ...
        <div class="d-flex">
            ...
            <div class="flex-grow-1 me-2">
                <!--begin::Username-->
                <a href="#" class="text-white text-hover-primary fs-6 fw-bold">{{Auth::user() ? Auth::user()->name : "-"}}</a>
                <!--end::Username-->
                <!--begin::Description-->
                ...
                <span class="bullet bullet-dot bg-success me-1"></span>Active
                </div>
                <!--end::Label-->
            </div>
            <!--end::Info-->
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            <!--begin::Avatar-->
                            <div class="symbol symbol-50px me-5" style="position: relative; overflow: hidden; width: 50px; height: 50px;"">
                                <img
                                src="{{URL::to('/')}}/assets/media/avatars/150-26.jpg"
                                alt="foto"
                                style="object-fit: cover; object-position: top; width: 100%; height: 100%; display: block;" />
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bolder d-flex align-items-center fs-5">{{Auth::user() ? Auth::user()->name : "-"}}</div>
                    ...
                    <div class="menu-item px-5">
                        <a href="../../demo8/dist/account/overview.html" class="menu-link px-5">Profilku</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
